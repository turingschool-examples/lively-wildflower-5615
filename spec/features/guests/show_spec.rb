...
RSpec.describe "guests show page" do
  ...
  describe "as a visitor" do
    describe "when I visit a guest's show page" do
      it "I see the guest's name, I see a list of all the rooms they've stayin in including the room's suite, nightly rate, and the name of the hotel that it belongs to" do
