...
RSpec.describe 'Guest Show Page', type: :feature do
    ...
    before(:each) do
        ...
        GuestRoom.create(room_id: @room_2.id, guest_id: @guest_3.id)
        GuestRoom.create(room_id: @room_3.id, guest_id: @guest_4.id)
        GuestRoom.create(room_id: @room_3.id, guest_id: @guest_3.id)
        GuestRoom.create(room_id: @room_4.id, guest_id: @guest_5.id)
        GuestRoom.create(room_id: @room_4.id, guest_id: @guest_6.id)
    end
